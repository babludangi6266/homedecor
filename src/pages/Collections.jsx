      ...
      <section className="py-24 md:py-40 bg-bg text-text relative overflow-hidden">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {[
              { name: "FSC-Certified Oak", img: "https://images.unsplash.com/photo-1546965158-b11566ef71f2?w=800&q=80", desc: "Responsibly sourced, slowly kiln-dried to prevent warping over decades of use." },
